    ...
    children: [
        ...
        children: [
          {
            path: "workbench",
            component: () =>
              import("@/views/TeleCustomerService/workbench/index.vue")
          },
          {
            path: "record",
            component: () =>
              import("@/views/TeleCustomerService/record/index.vue")
          }
        ]
      },
      {
        ...
        children: [
          ...
          },
          {
            path: "conversation",
            component: () =>
              import("@/views/qualityTesting/conversation/index.vue")
          }
        ]
      },
      {
        ...
        children: [
          {
            path: "customerManage",
            component: () =>
              import("@/views/customerCenter/customerManage/index.vue")
          },
          {
            path: "clue",
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: "personDetail",
            component: () =>
              import("@/views/dataAnalysis/personDetail/index.vue")
          },
          {
            path: "seat",
          ...
          },
          {
            path: "orderAnalysis",
            component: () =>
              import("@/views/dataAnalysis/orderAnalysis/index.vue")
          },
          {
            path: "orderClassification",
            component: () =>
              import("@/views/dataAnalysis/orderClassification/index.vue")
          }
        ]
      },
      {
        ...
        children: [
          ...
          },
          {
            path: "skillGroup",
            component: () =>
              import("@/views/staffManagement/skillGroup/index.vue")
          },
          {
            path: "role",
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "IVRSettings",
            component: () => import("@/views/setting/IVRSettings/index.vue")
          },
          {
            path: "leavingMessage",
            component: () => import("@/views/setting/leavingMessage/index.vue")
          },
          {
            path: "field",
          ...
          {
            path: "commonWords",
            component: () => import("@/views/setting/commonWords/index.vue")
          },
          {
            path: "qualityTesting",
          ...
          },
          {
            ...
            component: () =>
              import("@/views/setting/informationSafety/index.vue")
          }
        ]
      },
      {
