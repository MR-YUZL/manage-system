  ...
  computed: {
    ...
    avatar() {
      ...
      if (this.currentConversation.type === 'C2C') {
        if(this.isMine){
          return this.currentUserProfile.avatar ? this.currentUserProfile.avatar : require('./../../assets/imgs/current_session/customer_header.jpg')
        }else{
          return this.currentConversation.userProfile.avatar ? this.currentConversation.userProfile.avatar : require('./../../assets/imgs/current_session/header.png')
        }
